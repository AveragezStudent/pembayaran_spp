...
<div class="card mt-2">
<div class="card-body">
<h3 class="text-center">Halaman Pilih Data Siswa Untuk Pembayaran.</h3>
<hr>
<form action="pembayaran.php" method="GET">
<div class="d-flex justify-content-between">
<div class="input-group-append">
  <a href="admin.php?url=pembayaran" class="btn btn-outline-dark"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back</a>
  </div>
        ...
        <tr>
            ...
            <td>
                ...
                if($belum_bayar==0){
                    ...
                    <a href="?url=tambah-pembayaran&nisn=<?= $data['nisn']?>&belum_bayar=<?=$belum_bayar?>" class="btn btn-outline-danger"><i class="fa fa-cart-plus" aria-hidden="true"></i> Bayar</a>
                <?php }?>
            </td>   
            <td>
                <a href = "?url=history-pembayaran&nisn= <?= $data['nisn'] ?>" class="btn btn-outline-info"><i class="fa fa-history" aria-hidden="true"></i> History</a>
            </td>
        </tr>
    <?php }?>
</table>
