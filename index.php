        ...
        <div class="col-6">
          <div class="header">
            ...
            <div class="alert alert-warning" role="alert">
                Silahkan login dengan Username dan Password yang tersedia. Klik <a href="http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=db_spp&table=siswa" class="alert-link">disini</a> jika lupa dengan Username dan Password Anda!
            </div>
          </div>
          <div class="login-form">
            ...
            <input type="password" name="nis" class="form-control" placeholder="Masukkan NIS" required>
            <button type="submit" class="signin">LOGIN</button>
            <div class="text-center">
              <span class="d-inline">Admin/Petugas? <a href="index2.php"
